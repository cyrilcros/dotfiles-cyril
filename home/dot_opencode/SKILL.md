...
description: Use the Co-Scientist CLI as a subagent to answer questions about bioinformatics, Nextflow pipelines, Seqera Platform, and workflow management
triggers:
  - ask seqera
  - seqera agent
  - nextflow help
...
# Co-Scientist CLI Subagent

Use the Co-Scientist CLI in headless mode as a subagent to answer questions about:
...
The exact command is `seqera ai --headless "your question here"`.
Do not use `seqera --headless` — the `ai` subcommand is required.
...
4. You want to leverage Co-Scientist's specialized knowledge

## Reference Docs

For container workflows, read `references/containers.md` in this skill bundle.
Use it when the task is specifically about container images, Wave builds, or vulnerability scanning.
